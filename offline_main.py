...
def run_pipeline(data_path, paper_batch_size):
    ...
    global_metrics = {"Recall@150": 0.0, "Recall@600": 0.0, "MRR": 0.0}
    ...
    for i in range(0, total_papers, paper_batch_size):
        ...
        if batch_queries_count > 0:
            ...
            batch_metrics = {"Recall@150":0.0, "Recall@600":0.0, "MRR": 0.0}
            ...
            # 배치 평균 성능 출력
            print(f"[Batch 성능] Recall@150: {batch_metrics['Recall@150'] / batch_queries_count:.4f} | Recall@600: {batch_metrics['Recall@600'] / batch_queries_count:.4f} | MRR: {batch_metrics['MRR'] / batch_queries_count:.4f}")
